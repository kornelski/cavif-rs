...
use imgref::ImgVec;
use ravif::{AlphaColorMode, ColorModel, EncodedImage, Encoder, RGBA8};
use rayon::prelude::*;
use std::fs;
use std::io::Read;
use std::io::Write;
